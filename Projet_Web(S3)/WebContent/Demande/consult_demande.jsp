...
<body>
		...
		<div class="content" > 
			...
			<c:forEach items="${demandesList}" var="d">
						...
						<h1>Demande ${d.dem_id}<img alt="logo" src="${d.filename}" style="width:50%;float:right;"></h1>
				        ...
				        <c:choose>
				        	<c:when test="${d.dem_type=='Financement'}">
				        		...
				        		<p style="font-size:20px;"><b>Montant Demandé</b>:${d.montant_but}DH</p>
								<p style="font-size:20px;"><b>Montant Accumulé</b>:${d.montant_vrai}DH</p>
				        
							</c:when>
							<c:when test="${d.dem_type=='Benevolat'}">
								<p style="font-size:20px;"><b>Nb Benevoles Demandé</b>:${nbBenevoles_but} </p>
								<p style="font-size:20px;"><b>Nb Benevoles Accumulé</b>:${nbBenevoles_vrai} </p>
								<p style="font-size:20px;"><b>Heure Debut</b>${d.heure_debut}</p>
								<p style="font-size:20px;"><b>Heure Fin</b>${d.heure_fin}</p>
								<p style="font-size:20px;"><b>Adresse de l'Evenement</b>${d.adresse_benevolat}</p>
							</c:when>
